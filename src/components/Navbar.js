    ...
    <div className="flex justify-between items-center w-full h-20 px-4 bg-black text-white fixed z-10">
        ...
        {nav && (
            <ul className="flex flex-col justify-center items-center bg-gradient-to-b from-black to-gray-800 absolute top-0 left-0 w-full h-screen text-gray-500">
                <li className="px-4 py-6 text-gray-500 cursor-pointer capitalize text-4xl">home</li>
                <li className="px-4 py-6 text-gray-500 cursor-pointer capitalize text-4xl">about</li>
                <li className="px-4 py-6 text-gray-500 cursor-pointer capitalize text-4xl">portfolio</li>
                <li className="px-4 py-6 text-gray-500 cursor-pointer capitalize text-4xl">experience</li>
                <li className="px-4 py-6 text-gray-500 cursor-pointer capitalize text-4xl">contact</li>
            </ul>
        )}
